...
namespace WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Domain => Repository
            services.AddTransient(typeof(Domain.Interfaces.Base.IBaseInterface<>), typeof(BaseRepository<>));
            services.AddTransient<IUsuario, UsuarioRepository>();
            services.AddTransient<IPerfil, PerfilRepository>();
            services.AddTransient<IFuncionalidade, FuncionalidadeRepository>();
            //Business
            services.AddTransient<IUsuarioBusiness, UsuarioBusiness>();
            services.AddTransient<IPerfilBusiness, PerfilBusiness>();
            services.AddTransient<IFuncionalidadeBusiness, FuncionalidadeBusiness>();
        }
